...
<body>
            ...
            <div class="container py-5">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        ...
                        <form id="apartmentForm" enctype="multipart/form-data" onsubmit="saveApartment(event)">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Image Preview -->
                                    <div class="mt-2">
                                        <img id="imagePreview" src="" alt="Apartment Image Preview"
                                            style="max-width: 200px; max-height: 200px; display: none; border-radius: 8px; object-fit: cover; box-shadow: 0 0 8px rgba(0,0,0,0.2);">
                                    </div>

                                    <small class="text-muted">Allowed types: jpg, jpeg, png, gif, webp. Max size:
                                        2MB</small>
                                </div>
    ...
    <script>
        ...
        async function saveApartment(event) {
            ...
            let url = '/api/v1/admin/dashboard/apartments';
            let method = 'post';
            try {
